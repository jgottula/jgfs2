...
void jgfs2_new_post(void) {
	...
	jgfs2_tree_init(fs.sblk->s_addr_ext_tree);
	jgfs2_tree_init(fs.sblk->s_addr_meta_tree);
	
	jgfs2_node_dump(fs.sblk->s_addr_ext_tree);
	jgfs2_node_dump(fs.sblk->s_addr_meta_tree);
